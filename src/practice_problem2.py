...
def run_test_practice_problem2a():
    ...
    expected = [3, 38, 18]
    answer = practice_problem2a([-5, 30, 10], 8)
    print('Expected:', expected)
    print('answer :', answer)

    expected = [0, 21, 26, 9]
    answer = practice_problem2a([-7, 14, 19, 2], 7)
    print('Expected:', expected)
    print('answer :', answer)

    expected = [-3, 32, 12, 17, 3, 62]
    answer = practice_problem2a([-5, 30, 10, 15, 1, 60], 2)
    print('Expected:', expected)
    print('answer :', answer)

    expected = [8, 14, 24, 8, 9]
    answer = practice_problem2a([3, 9, 19, 3, 4], 5)
    print('Expected:', expected)
    print('answer :', answer)
...
def practice_problem2b(sequence):
    ...
    for k in range(len(sequence)):
        ...
        if i > 0:
            ...
            needed_sequence = needed_sequence + sequence1[0]
        else:
            needed_sequence = needed_sequence + ''


    return needed_sequence
